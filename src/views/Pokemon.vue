<template>
  <div class="detail">
    <div class="detail-view">
      ...
      <router-link to="/"><button class="close">return</button></router-link>
    </div>
  </div>
</template>
...
<style lang="scss" scoped>
  .detail {
    ...
    .detail-view {
      ...
      max-width: 510px;
      padding: 20px;
      background: linear-gradient(to right top, #3d7dca, #306bb3, #225a9c, #134a86, #003a70);      border-radius: 5px;
